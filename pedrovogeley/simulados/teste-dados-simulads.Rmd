...
macmata <- read_excel("pedrovogeley/simulados/mac-mata.xlsx")
View(macmata)
mactransecto <- read_excel("pedrovogeley/simulados/mac-transecto.xlsx")
View(mactransecto)
macteste1 <- read_excel("pedrovogeley/simulados/mac-teste1.xlsx")
View(mac_teste1)
macteste2 <- read_excel("pedrovogeley/simulados/mac-teste2.xlsx")
View(macteste2)
macteste3 <- read_excel("pedrovogeley/simulados/mac-teste3.xlsx")
View(macteste3)
```
...
Agora os dados do teste 3

```{r}
dadoteste3 <-iNEXT(macteste3$conta, q=0, datatype = "abundance")
ggiNEXT(dadoteste3, type=1, se=TRUE, facet.var="none", color.var="site", grey=FALSE)
```
